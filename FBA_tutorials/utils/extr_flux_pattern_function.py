...
def extr_flux_pattern(file_list, analysis = 'pFBA'):
    '''
    USAGE
    
    resultDict = extr_flux_pattern(file_list, analysis_type)
    
    INPUTS 
    
    file list : list of models in json format
    
    analysis type : FBA, pFBA, FVA_opt, FVA_no_opt
    
    OUTPUT 
    
    resultDict = Dictionary{ cell_line: DataFrame of flux pattern}
    ...
    print()
    print('My list of files is :'+ str(file_list).replace('[','').replace(']',''))
    print()
...
# choose which Analysis to perform
    ...
    print()
    print('The flux pattern will be computed using '+ analysis)
    print('_______________________________________________________________________________ ')
